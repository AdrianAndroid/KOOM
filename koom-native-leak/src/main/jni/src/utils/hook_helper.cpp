...
bool HookHelper::HookMethods(
    ...
    register_pattern_ = std::move(register_pattern); // std::move转移右值的作用
    ignore_pattern_ = std::move(ignore_pattern); // std::move转移右值的作用
    methods_ = std::move(methods); // std::move转移右值的作用

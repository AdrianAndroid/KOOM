...
internal object SystemInfo {
    ...
    fun refresh() {
        ...
        MonitorLog.i(TAG + "refresh()>>>", javaHeap.toString())
        MonitorLog.i(TAG + "refresh()>>>", procStatus.toString())
        MonitorLog.i(TAG + "refresh()>>>", memInfo.toString())
    }

    data class ProcStatus(var thread: Int = 0, var vssInKb: Int = 0, var rssInKb: Int = 0) {
        override fun toString(): String {
            return "ProcStatus(thread=$thread, vssInKb=$vssInKb, rssInKb=$rssInKb)"
        }
    }
    ...
    data class MemInfo(
        ...
        override fun toString(): String {
            return "MemInfo(totalInKb=$totalInKb, freeInKb=$freeInKb, availableInKb=$availableInKb, IONHeap=$IONHeap, cmaTotal=$cmaTotal, rate=$rate)"
        }
    }
    ...
    data class JavaHeap(
        ...
        override fun toString(): String {
            return "JavaHeap(max=$max, total=$total, free=$free, used=$used, rate=$rate)"
        }
    }

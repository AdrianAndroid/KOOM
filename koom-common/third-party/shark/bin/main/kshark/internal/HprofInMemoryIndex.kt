...
internal class HprofInMemoryIndex private constructor(
    ...
    override fun toString(): String {
        return "HprofInMemoryIndex(positionSize=$positionSize, hprofStringCache=$hprofStringCache, classNames=$classNames, classIndex=$classIndex, instanceIndex=$instanceIndex, objectArrayIndex=$objectArrayIndex, primitiveArrayIndex=$primitiveArrayIndex, gcRoots=$gcRoots, proguardMapping=$proguardMapping, bytesForClassSize=$bytesForClassSize, bytesForInstanceSize=$bytesForInstanceSize, bytesForObjectArraySize=$bytesForObjectArraySize, bytesForPrimitiveArraySize=$bytesForPrimitiveArraySize, useForwardSlashClassPackageSeparator=$useForwardSlashClassPackageSeparator, classFieldsReader=$classFieldsReader, classFieldsIndexSize=$classFieldsIndexSize, classCount=$classCount, instanceCount=$instanceCount, objectArrayCount=$objectArrayCount, primitiveArrayCount=$primitiveArrayCount)"
    }
